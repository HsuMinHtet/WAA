...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserDetailDTO addUser(UserDetailDTO userDTO) {
        validationUserData(userDTO);
        return modelMapper.map(userRepo.save(modelMapper.map(userDTO, Users.class)), UserDetailDTO.class);
    }
    ...
    public List<UserDetailDTO> findAllUserByTitle(String postTitle) {
        ...
        List<Users> userList = userRepo.findAllUserByTitle(postTitle);
