package edu.miu.waa.lab2.config;


import edu.miu.waa.lab2.filter.JwtFilter;
...
//  String [] roles = {"CLIENT"}; // Try this :)
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/posts").hasAuthority("CLIENT")
                .requestMatchers("/users").hasAnyAuthority("ADMIN") // Dynamic authorities
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
