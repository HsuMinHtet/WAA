...
public class UserController {
    ...
    @LogMe
    @GetMapping("/{userId}")
    public ResponseEntity<UserDetailDTO> findUserById(@PathVariable Long userId) throws MyException {
    ...
    @LogMe
    @PostMapping
    public ResponseEntity<UserDetailDTO> addUser(@RequestBody UserDetailDTO userDTO) throws MyException {
    ...
    public ResponseEntity<?> deleteUser(@PathVariable Long userId) throws MyException {
    ...
    public ResponseEntity<List<PostDTO>> findPostByUserId(@PathVariable Long userId) throws MyException {
